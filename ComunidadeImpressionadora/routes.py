...
from ComunidadeImpressionadora.forms import FormLogin, FormCriarConta, FormEditarPerfil, FormCriarPost, FormComentarPost
...
lista_usuarios = ['pedro', 'stefany', 'thifany', 'daniel', 'teresa']
...
def salvar_imagem(imagem):
    ...
    # adicionar um codigo aleatorio pro codigo da imagem
...
@app.route("/post/<post_id>/editar", methods=['POST', 'GET'])
@login_required
def editar_post(post_id):
    ...
    return render_template("editar_post.html", post=post, form_editarpost=form_editarpost, form_comentarpost=form_comentarpost)
